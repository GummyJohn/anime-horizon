        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div 
                className={state.show ? 'mx-4 text-orange-500cursor-pointer' : 'mx-4 cursor-pointer'}
            ...
            <div className='mx-4'>
              ...
              {added && (
                <div className='relative top-2'>
                  <div 
                    className='absolute h-5 w-5 right-8 top-[-1px] rotate-45 bg-black border-orange-500 border-t-2 border-l-2 z-10'
                  >
                  </div>
